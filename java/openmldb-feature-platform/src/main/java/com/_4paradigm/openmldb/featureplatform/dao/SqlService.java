...
public class SqlService {
    ...
    public void initDbAndTables() throws SQLException {
        ...
        sql = "CREATE TABLE IF NOT EXISTS SYSTEM_FEATURE_PLATFORM.feature_services (name string, version string, feature_list string, db string, sql string, deployment string, INDEX(KEY=(name, version)))";
        openmldbStatement.execute(sql);
